CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.asset_class_annex (
  id VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/asset_class_annex',
  max_commit_retry=10
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.asset_collections_timeline (
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/asset_collections_timeline',
  max_commit_retry=10,
...
CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.asset_contractual_expected_cash_flows (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  reference_date DATE,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/asset_contractual_expected_cash_flows',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.asset_extended_periodic_reports (
  asset_id VARCHAR,
  asset_class INTEGER,
  asset_role VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/asset_extended_periodic_reports',
  max_commit_retry=10,
...
CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.asset_modification_events (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  asset_id VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/asset_modification_events',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.asset_realized_cash_flows (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  reference_date DATE,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/asset_realized_cash_flows',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.asset_table_results (
  asset_identifier VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  id VARCHAR,
  proposal_id VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/asset_table_results',
  max_commit_retry=10,
  partitioning=ARRAY['proposal_id', 'section_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.assets (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  originator_identifier VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/assets',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.backing_history (
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  id VARCHAR,
  backing_id VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/backing_history',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.backings (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/backings',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.business_plans (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  identifier VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/business_plans',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.cluster_configurations (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/cluster_configurations',
  max_commit_retry=10
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.collateral_cash_flows (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  reference_date DATE,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/collateral_cash_flows',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.collateral_daily_reports (
  investment_id VARCHAR,
  collateral_id VARCHAR,
  asset_id VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/collateral_daily_reports',
  max_commit_retry=10,
...
CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.collateral_events (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  collateral_id VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/collateral_events',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.collateral_extended_periodic_reports (
  investment_id VARCHAR,
  originator_id VARCHAR,
  spv_id VARCHAR,
  collateral_id VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/collateral_extended_periodic_reports',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['synchronization_id', 'collateral_id', 'investment_id', 'investment_periodic_report_id'],
  partitioning=ARRAY['originator_id', 'spv_id', 'synchronization_reporting_date']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.collateral_periodic_reports (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/collateral_periodic_reports',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id', 'reporting_date']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.collateral_valuations (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  reference_date DATE,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/collateral_valuations',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.collaterals (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  asset_id VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/collaterals',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.commercial_credit_asset_history (
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  issue_amount DECIMAL(20, 6),
  converted_issue_amount DECIMAL(20, 6),
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/commercial_credit_asset_history',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.commercial_credit_assets (
  issue_amount DECIMAL(20, 6),
  converted_issue_amount DECIMAL(20, 6),
  id VARCHAR,
  asset_class INTEGER,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/commercial_credit_assets',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.companies (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  originator_id VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/companies',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.company_logs (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  company_id VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/company_logs',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.construction_project_milestones (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/construction_project_milestones',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.construction_project_periodic_reports (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  construction_project_id VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/construction_project_periodic_reports',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.construction_projects (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/construction_projects',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.currency (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  name VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/currency',
  max_commit_retry=10
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.demo_table_results (
  asset_identifier VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  id VARCHAR,
  proposal_id VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/demo_table_results',
  max_commit_retry=10,
  partitioning=ARRAY['proposal_id', 'section_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.dhc_results (
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/dhc_results',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.enforcement_procedure_periodic_reports (
  id VARCHAR,
  reporting_date DATE,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/enforcement_procedure_periodic_reports',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.enforcement_procedures (
  id VARCHAR,
  identifier VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/enforcement_procedures',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.equipment_asset_history (
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  valid_until DATE,
  id VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/equipment_asset_history',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.equipment_assets (
  id VARCHAR,
  asset_class INTEGER,
  oem VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/equipment_assets',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.external_validations (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  custom_fields MAP(VARCHAR, VARCHAR),
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/external_validations',
  max_commit_retry=10
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.financial_credit_asset_history (
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  interest_rate_type INTEGER,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/financial_credit_asset_history',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.financial_credit_assets (
  interest_rate_type INTEGER,
  financing_purpose INTEGER,
  issue_amount DECIMAL(20, 6),
  interest_rate_floor DECIMAL(7, 6),
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/financial_credit_assets',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.fund_assets (
  id VARCHAR,
  asset_class INTEGER,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/fund_assets',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.geography (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  continent VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/geography',
  max_commit_retry=10
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.geography_info (
  id VARCHAR,
  borrower_country_name VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/geography_info',
  max_commit_retry=10
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.guarantee_asset_history (
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  id VARCHAR,
  asset_id VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/guarantee_asset_history',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.guarantee_assets (
  id VARCHAR,
  asset_class INTEGER,
  guarantee_coverage_percent DOUBLE,
  date_activation_guarantee DATE,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/guarantee_assets',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.individual_logs (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/individual_logs',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.individuals (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  originator_identifier VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/individuals',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.investment_daily_reports (
  investment_id VARCHAR,
  reporting_date DATE,
  investment_periodic_report_id VARCHAR,
  asset_id VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/investment_daily_reports',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['synchronization_id', 'asset_id', 'investment_id', 'investment_periodic_report_id'],
  partitioning=ARRAY['originator_id', 'spv_id', 'reporting_date']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.investment_esma (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  standard VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/investment_esma',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.investment_expected_cash_flows (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  reference_date DATE,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/investment_expected_cash_flows',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.investment_extended_periodic_reports (
  investment_id VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/investment_extended_periodic_reports',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['synchronization_id', 'investment_id'],
  partitioning=ARRAY['originator_id', 'spv_id', 'synchronization_reporting_date']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.investment_periodic_report_esma (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  investment_periodic_report_id VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/investment_periodic_report_esma',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.investment_periodic_report_reported_ratings (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  investment_periodic_report_id VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/investment_periodic_report_reported_ratings',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.investment_periodic_reports (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  reporting_date DATE,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/investment_periodic_reports',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['created_via_backfill', 'originator_id', 'spv_id', 'reporting_date']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.investment_realized_cash_flows (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  reference_date DATE,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/investment_realized_cash_flows',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.investment_valuations (
  investment_id VARCHAR,
  spv_id VARCHAR,
  originator_id VARCHAR,
  id VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/investment_valuations',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.investments (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  asset_id VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/investments',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.investments_enforcement_procedures (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  investment_id VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/investments_enforcement_procedures',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.migration_history (
  name VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/migration_history',
  max_commit_retry=10
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.milestones (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/milestones',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.originators (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  name VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/originators',
  max_commit_retry=10
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.other_creditors_prior_liens (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  collateral_id VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/other_creditors_prior_liens',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.proposals (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  status INTEGER,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/proposals',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.real_estate_asset_history (
  id VARCHAR,
  asset_id VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/real_estate_asset_history',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.real_estate_assets (
  asset_class INTEGER,
  id VARCHAR,
  asset_type INTEGER,
  property_type INTEGER,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/real_estate_assets',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.real_estate_extended_assets (
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/real_estate_extended_assets',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['synchronization_id', 'real_estate_id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.real_estate_extended_periodic_reports (
  real_estate_id VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/real_estate_extended_periodic_reports',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['synchronization_id', 'real_estate_id'],
  partitioning=ARRAY['originator_id', 'spv_id', 'synchronization_reporting_date']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.results (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  spv_id VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/results',
  max_commit_retry=10,
  partitioning=ARRAY['spv_id', 'section_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.retrieve_results (
  external_job_id VARCHAR,
  results VARCHAR,
  sync_job_id VARCHAR,
  originator_id VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/retrieve_results',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.sector (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  standard INTEGER,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/sector',
  max_commit_retry=10
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.sector_info (
  id VARCHAR,
  borrower_sector_name VARCHAR,
  borrower_sector_code VARCHAR,
  borrower_sector_standard INTEGER,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/sector_info',
  max_commit_retry=10
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.sector_relation (
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  id VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/sector_relation',
  max_commit_retry=10
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.simulation_output (
  reference_date DATE,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/simulation_output',
  max_commit_retry=10,
  partitioning=ARRAY['spv_id', 'simulation_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.spv_cash_account_periodic_reports (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  reporting_date DATE,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/spv_cash_account_periodic_reports',
  max_commit_retry=10,
  partitioning=ARRAY['spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.spv_cash_accounts (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  spv_id VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/spv_cash_accounts',
  max_commit_retry=10,
  partitioning=ARRAY['spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.spv_cash_flows (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  reference_date DATE,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/spv_cash_flows',
  max_commit_retry=10,
  partitioning=ARRAY['spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.spv_counterparties (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  name VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/spv_counterparties',
  max_commit_retry=10,
  partitioning=ARRAY['spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.spv_counterparty_logs (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  custom_fields MAP(VARCHAR, VARCHAR),
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/spv_counterparty_logs',
  max_commit_retry=10,
  partitioning=ARRAY['spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.spv_counterparty_roles (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/spv_counterparty_roles',
  max_commit_retry=10,
  partitioning=ARRAY['spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.spv_liabilities (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  spv_id VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/spv_liabilities',
  max_commit_retry=10,
  partitioning=ARRAY['spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.spv_liability_periodic_reports (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  reporting_date DATE,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/spv_liability_periodic_reports',
  max_commit_retry=10,
  partitioning=ARRAY['spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.spv_monthly_performance (
  spv_id VARCHAR,
  spv_identifier VARCHAR,
  period_start DATE,
  period_end DATE,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/spv_monthly_performance',
  max_commit_retry=10,
  partitioning=ARRAY['spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.spv_periodic_reports (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  reporting_date DATE,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/spv_periodic_reports',
  max_commit_retry=10,
  partitioning=ARRAY['spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.spv_quarterly_performance (
  spv_id VARCHAR,
  spv_identifier VARCHAR,
  period_start DATE,
  period_end DATE,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/spv_quarterly_performance',
  max_commit_retry=10,
  partitioning=ARRAY['spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.spv_trigger_periodic_reports (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  reporting_date DATE,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/spv_trigger_periodic_reports',
  max_commit_retry=10,
  partitioning=ARRAY['spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.spv_triggers (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  spv_id VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/spv_triggers',
  max_commit_retry=10,
  partitioning=ARRAY['spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.spv_yearly_performance (
  spv_id VARCHAR,
  spv_identifier VARCHAR,
  period_start DATE,
  period_end DATE,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/spv_yearly_performance',
  max_commit_retry=10,
  partitioning=ARRAY['spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.spvs (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  name VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/spvs',
  max_commit_retry=10,
  partitioning=ARRAY['id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.standardization_results (
  external_job_id VARCHAR,
  results VARCHAR,
  sync_job_id VARCHAR,
  originator_id VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/standardization_results',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.subscription_allocations (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  investment_id VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/subscription_allocations',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.subscription_daily_reports (
  subscription_id VARCHAR,
  reporting_date DATE,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/subscription_daily_reports',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['synchronization_id', 'subscription_id', 'subscription_periodic_report_id'],
  partitioning=ARRAY['originator_id', 'spv_id', 'reporting_date']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.subscription_periodic_reports (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  reporting_date DATE,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/subscription_periodic_reports',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id', 'reporting_date']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.subscriptions (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  originator_identifier VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/subscriptions',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.sync_job_resources (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  sync_job_id VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/sync_job_resources',
  max_commit_retry=10
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.sync_jobs (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/sync_jobs',
  max_commit_retry=10,
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.synchronization_accounts (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  spv_id VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/synchronization_accounts',
  max_commit_retry=10
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.user_input_results (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  value VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/user_input_results',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.user_inputs (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  name VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/user_inputs',
  max_commit_retry=10
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.vehicle_asset_history (
  id VARCHAR,
  asset_id VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/vehicle_asset_history',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.vehicle_assets (
  id VARCHAR,
  originator_id VARCHAR,
  asset_class INTEGER,
  oem_identifier VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/vehicle_assets',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.waterfall_available_funds (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  name VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/waterfall_available_funds',
  max_commit_retry=10
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.waterfall_available_funds_history (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  valid_until DATE,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/waterfall_available_funds_history',
  max_commit_retry=10
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.waterfall_available_funds_results (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  available_funds_id VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/waterfall_available_funds_results',
  max_commit_retry=10
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.waterfall_executions (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/waterfall_executions',
  max_commit_retry=10
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.waterfall_input_component_results (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  name VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/waterfall_input_component_results',
  max_commit_retry=10
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.waterfall_input_components (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  spv_id VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/waterfall_input_components',
  max_commit_retry=10
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.waterfall_payment_results (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  payment_id VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/waterfall_payment_results',
  max_commit_retry=10
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.waterfall_payment_sections (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  name VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/waterfall_payment_sections',
  max_commit_retry=10
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.waterfall_payment_sections_history (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  valid_until DATE,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/waterfall_payment_sections_history',
  max_commit_retry=10
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.waterfall_payments (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  name VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/waterfall_payments',
  max_commit_retry=10
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.waterfall_payments_history (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  valid_until DATE,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/waterfall_payments_history',
  max_commit_retry=10
);

CREATE TABLE "staging-equalizer".cardoai_eu_st_glue_db_equalizer.waterfalls (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  spv_id VARCHAR,
...
WITH (
  ...
  format='PARQUET',
  format_version=2,
  LOCATION='s3://cardoai-eu-st-s3-bucket-equalizer-data-lakehouse/iceberg_tables/waterfalls',
  max_commit_retry=10
);
