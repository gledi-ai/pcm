CREATE TABLE IF NOT EXISTS ice.equalizer_data.asset_class_annex (
  id VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/asset_class_annex',
  max_commit_retry=10
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.asset_collections_timeline (
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/asset_collections_timeline',
  max_commit_retry=10,
...
CREATE TABLE IF NOT EXISTS ice.equalizer_data.asset_contractual_expected_cash_flows (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  reference_date DATE,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/asset_contractual_expected_cash_flows',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.asset_extended_periodic_reports (
  asset_id VARCHAR,
  asset_class INTEGER,
  asset_role VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/asset_extended_periodic_reports',
  max_commit_retry=10,
...
CREATE TABLE IF NOT EXISTS ice.equalizer_data.asset_modification_events (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  asset_id VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/asset_modification_events',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.asset_realized_cash_flows (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  reference_date DATE,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/asset_realized_cash_flows',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.asset_table_results (
  asset_identifier VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  id VARCHAR,
  proposal_id VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/asset_table_results',
  max_commit_retry=10,
  partitioning=ARRAY['proposal_id', 'section_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.assets (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  originator_identifier VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/assets',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.backing_history (
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  id VARCHAR,
  backing_id VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/backing_history',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.backings (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/backings',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.business_plans (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  identifier VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/business_plans',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.cluster_configurations (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/cluster_configurations',
  max_commit_retry=10
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.collateral_cash_flows (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  reference_date DATE,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/collateral_cash_flows',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.collateral_daily_reports (
  investment_id VARCHAR,
  collateral_id VARCHAR,
  asset_id VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/collateral_daily_reports',
  max_commit_retry=10,
...
CREATE TABLE IF NOT EXISTS ice.equalizer_data.collateral_events (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  collateral_id VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/collateral_events',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.collateral_extended_periodic_reports (
  investment_id VARCHAR,
  originator_id VARCHAR,
  spv_id VARCHAR,
  collateral_id VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/collateral_extended_periodic_reports',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['synchronization_id', 'collateral_id', 'investment_id', 'investment_periodic_report_id'],
  partitioning=ARRAY['originator_id', 'spv_id', 'synchronization_reporting_date']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.collateral_periodic_reports (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/collateral_periodic_reports',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id', 'reporting_date']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.collateral_valuations (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  reference_date DATE,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/collateral_valuations',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.collaterals (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  asset_id VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/collaterals',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.commercial_credit_asset_history (
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  issue_amount DECIMAL(20, 6),
  converted_issue_amount DECIMAL(20, 6),
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/commercial_credit_asset_history',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.commercial_credit_assets (
  issue_amount DECIMAL(20, 6),
  converted_issue_amount DECIMAL(20, 6),
  id VARCHAR,
  asset_class INTEGER,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/commercial_credit_assets',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.companies (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  originator_id VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/companies',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.company_logs (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  company_id VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/company_logs',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.currency (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  name VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/currency',
  max_commit_retry=10
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.demo_table_results (
  asset_identifier VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  id VARCHAR,
  proposal_id VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/demo_table_results',
  max_commit_retry=10,
  partitioning=ARRAY['proposal_id', 'section_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.dhc_results (
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/dhc_results',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.enforcement_procedure_periodic_reports (
  id VARCHAR,
  reporting_date DATE,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/enforcement_procedure_periodic_reports',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.enforcement_procedures (
  id VARCHAR,
  identifier VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/enforcement_procedures',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.equipment_asset_history (
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  valid_until DATE,
  id VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/equipment_asset_history',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.equipment_assets (
  id VARCHAR,
  asset_class INTEGER,
  oem VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/equipment_assets',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.external_validations (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  custom_fields MAP(VARCHAR, VARCHAR),
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/external_validations',
  max_commit_retry=10
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.financial_credit_asset_history (
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  interest_rate_type INTEGER,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/financial_credit_asset_history',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.financial_credit_assets (
  interest_rate_type INTEGER,
  financing_purpose INTEGER,
  issue_amount DECIMAL(20, 6),
  interest_rate_floor DECIMAL(7, 6),
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/financial_credit_assets',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.fund_assets (
  id VARCHAR,
  asset_class INTEGER,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/fund_assets',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.geography (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  continent VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/geography',
  max_commit_retry=10
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.geography_info (
  id VARCHAR,
  borrower_country_name VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/geography_info',
  max_commit_retry=10
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.guarantee_asset_history (
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  id VARCHAR,
  asset_id VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/guarantee_asset_history',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.guarantee_assets (
  id VARCHAR,
  asset_class INTEGER,
  guarantee_coverage_percent DOUBLE,
  date_activation_guarantee DATE,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/guarantee_assets',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.individual_logs (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/individual_logs',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.individuals (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  originator_identifier VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/individuals',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.investment_daily_reports (
  investment_id VARCHAR,
  reporting_date DATE,
  investment_periodic_report_id VARCHAR,
  asset_id VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/investment_daily_reports',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['synchronization_id', 'asset_id', 'investment_id', 'investment_periodic_report_id'],
  partitioning=ARRAY['originator_id', 'spv_id', 'reporting_date']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.investment_esma (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  standard VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/investment_esma',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.investment_expected_cash_flows (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  reference_date DATE,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/investment_expected_cash_flows',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.investment_extended_periodic_reports (
  investment_id VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/investment_extended_periodic_reports',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['synchronization_id', 'investment_id'],
  partitioning=ARRAY['originator_id', 'spv_id', 'synchronization_reporting_date']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.investment_periodic_report_esma (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  investment_periodic_report_id VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/investment_periodic_report_esma',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.investment_periodic_report_reported_ratings (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  investment_periodic_report_id VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/investment_periodic_report_reported_ratings',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.investment_periodic_reports (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  reporting_date DATE,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/investment_periodic_reports',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['created_via_backfill', 'originator_id', 'spv_id', 'reporting_date']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.investment_realized_cash_flows (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  reference_date DATE,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/investment_realized_cash_flows',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.investment_valuations (
  investment_id VARCHAR,
  spv_id VARCHAR,
  originator_id VARCHAR,
  id VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/investment_valuations',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.investments (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  asset_id VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/investments',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.investments_enforcement_procedures (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  investment_id VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/investments_enforcement_procedures',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.originators (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  name VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/originators',
  max_commit_retry=10
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.other_creditors_prior_liens (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  collateral_id VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/other_creditors_prior_liens',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.proposals (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  status INTEGER,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/proposals',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.real_estate_asset_history (
  id VARCHAR,
  asset_id VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/real_estate_asset_history',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.real_estate_assets (
  asset_class INTEGER,
  id VARCHAR,
  asset_type INTEGER,
  property_type INTEGER,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/real_estate_assets',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.real_estate_extended_assets (
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/real_estate_extended_assets',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['synchronization_id', 'real_estate_id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.real_estate_extended_periodic_reports (
  real_estate_id VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/real_estate_extended_periodic_reports',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['synchronization_id', 'real_estate_id'],
  partitioning=ARRAY['originator_id', 'spv_id', 'synchronization_reporting_date']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.retrieve_results (
  external_job_id VARCHAR,
  results VARCHAR,
  sync_job_id VARCHAR,
  originator_id VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/retrieve_results',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.sector (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  standard INTEGER,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/sector',
  max_commit_retry=10
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.sector_info (
  id VARCHAR,
  borrower_sector_name VARCHAR,
  borrower_sector_code VARCHAR,
  borrower_sector_standard INTEGER,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/sector_info',
  max_commit_retry=10
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.sector_relation (
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  id VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/sector_relation',
  max_commit_retry=10
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.simulation_output (
  reference_date DATE,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/simulation_output',
  max_commit_retry=10,
  partitioning=ARRAY['spv_id', 'simulation_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.spv_cash_account_periodic_reports (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  reporting_date DATE,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/spv_cash_account_periodic_reports',
  max_commit_retry=10,
  partitioning=ARRAY['spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.spv_cash_accounts (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  spv_id VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/spv_cash_accounts',
  max_commit_retry=10,
  partitioning=ARRAY['spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.spv_cash_flows (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  reference_date DATE,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/spv_cash_flows',
  max_commit_retry=10,
  partitioning=ARRAY['spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.spv_counterparties (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  name VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/spv_counterparties',
  max_commit_retry=10,
  partitioning=ARRAY['spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.spv_counterparty_logs (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  custom_fields MAP(VARCHAR, VARCHAR),
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/spv_counterparty_logs',
  max_commit_retry=10,
  partitioning=ARRAY['spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.spv_counterparty_roles (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/spv_counterparty_roles',
  max_commit_retry=10,
  partitioning=ARRAY['spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.spv_liabilities (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  spv_id VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/spv_liabilities',
  max_commit_retry=10,
  partitioning=ARRAY['spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.spv_liability_periodic_reports (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  reporting_date DATE,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/spv_liability_periodic_reports',
  max_commit_retry=10,
  partitioning=ARRAY['spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.spv_monthly_performance (
  spv_id VARCHAR,
  spv_identifier VARCHAR,
  period_start DATE,
  period_end DATE,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/spv_monthly_performance',
  max_commit_retry=10,
  partitioning=ARRAY['spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.spv_periodic_reports (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  reporting_date DATE,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/spv_periodic_reports',
  max_commit_retry=10,
  partitioning=ARRAY['spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.spv_quarterly_performance (
  spv_id VARCHAR,
  spv_identifier VARCHAR,
  period_start DATE,
  period_end DATE,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/spv_quarterly_performance',
  max_commit_retry=10,
  partitioning=ARRAY['spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.spv_trigger_periodic_reports (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  reporting_date DATE,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/spv_trigger_periodic_reports',
  max_commit_retry=10,
  partitioning=ARRAY['spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.spv_triggers (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  spv_id VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/spv_triggers',
  max_commit_retry=10,
  partitioning=ARRAY['spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.spv_yearly_performance (
  spv_id VARCHAR,
  spv_identifier VARCHAR,
  period_start DATE,
  period_end DATE,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/spv_yearly_performance',
  max_commit_retry=10,
  partitioning=ARRAY['spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.spvs (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  name VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/spvs',
  max_commit_retry=10,
  partitioning=ARRAY['id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.standardization_results (
  external_job_id VARCHAR,
  results VARCHAR,
  sync_job_id VARCHAR,
  originator_id VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/standardization_results',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.subscription_allocations (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  investment_id VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/subscription_allocations',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.subscription_daily_reports (
  subscription_id VARCHAR,
  reporting_date DATE,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/subscription_daily_reports',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['synchronization_id', 'subscription_id', 'subscription_periodic_report_id'],
  partitioning=ARRAY['originator_id', 'spv_id', 'reporting_date']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.subscription_periodic_reports (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  reporting_date DATE,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/subscription_periodic_reports',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id', 'reporting_date']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.subscriptions (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  originator_identifier VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/subscriptions',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.sync_job_resources (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  sync_job_id VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/sync_job_resources',
  max_commit_retry=10
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.sync_jobs (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/sync_jobs',
  max_commit_retry=10,
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.synchronization_accounts (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  spv_id VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/synchronization_accounts',
  max_commit_retry=10
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.user_input_results (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  value VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/user_input_results',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.user_inputs (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  name VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/user_inputs',
  max_commit_retry=10
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.vehicle_asset_history (
  id VARCHAR,
  asset_id VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/vehicle_asset_history',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.vehicle_assets (
  id VARCHAR,
  originator_id VARCHAR,
  asset_class INTEGER,
  oem_identifier VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/vehicle_assets',
  max_commit_retry=10,
  parquet_bloom_filter_columns=ARRAY['id'],
  partitioning=ARRAY['originator_id', 'spv_id']
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.waterfall_available_funds (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  name VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/waterfall_available_funds',
  max_commit_retry=10
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.waterfall_available_funds_history (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  valid_until DATE,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/waterfall_available_funds_history',
  max_commit_retry=10
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.waterfall_available_funds_results (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  available_funds_id VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/waterfall_available_funds_results',
  max_commit_retry=10
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.waterfall_executions (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/waterfall_executions',
  max_commit_retry=10
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.waterfall_input_component_results (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  name VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/waterfall_input_component_results',
  max_commit_retry=10
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.waterfall_input_components (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  spv_id VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/waterfall_input_components',
  max_commit_retry=10
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.waterfall_payment_results (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  payment_id VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/waterfall_payment_results',
  max_commit_retry=10
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.waterfall_payment_sections (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  name VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/waterfall_payment_sections',
  max_commit_retry=10
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.waterfall_payment_sections_history (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  valid_until DATE,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/waterfall_payment_sections_history',
  max_commit_retry=10
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.waterfall_payments (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  name VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/waterfall_payments',
  max_commit_retry=10
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.waterfall_payments_history (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  valid_until DATE,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/waterfall_payments_history',
  max_commit_retry=10
);

CREATE TABLE IF NOT EXISTS ice.equalizer_data.waterfalls (
  id VARCHAR,
  created_at TIMESTAMP(6) WITH TIME ZONE,
  updated_at TIMESTAMP(6) WITH TIME ZONE,
  spv_id VARCHAR,
...
WITH (
  format='PARQUET',
  format_version=2,
  LOCATION='s3://warehouse/equalizer_data/waterfalls',
  max_commit_retry=10
);
